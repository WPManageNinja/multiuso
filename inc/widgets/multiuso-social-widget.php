...
class MULTIUSO_Social_Widget extends WP_Widget{
   
	//setup the widget name, description , etc.
    public function __construct(){
            $widget_ops = array(
                'classname' => 'multiuso_social_widget',
                'description' => esc_html__('Display Social list widget', 'multiuso')
            );

            parent::__construct('multiuso_social', esc_html__('Multiuso Social Links', 'multiuso'), $widget_ops);
    }
    ...
    ?>
    	<p>
	        <label for="<?php echo esc_attr($this->get_field_id('title'));?>">
			    <?php echo esc_html__('Title:', 'multiuso');?>
		    </label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('google_scholar_link'));?>">
				<?php echo esc_html__('Google Scholar Link', 'multiuso');?>
			</label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('facebook_link'));?>">
	            <?php echo esc_html__('Facebook Link', 'multiuso');?>
            </label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('twitter_link'));?>">
				<?php echo esc_html__('Twitter Link', 'multiuso');?>
			</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('linkedin_link'));?>">
				<?php echo esc_html__('Linkedin Link', 'multiuso');?>
			</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('youtube_link'));?>">
				<?php echo esc_html__('Youtube Link', 'multiuso');?>
			</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('google_plus_link'));?>">
				<?php echo esc_html__('Google Plus Link', 'multiuso');?>
			</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('instagram_link'));?>">
				<?php echo esc_html__('Instagram Link', 'multiuso');?>
			</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('pinterest_link'));?>">
				<?php echo esc_html__('Pinterest Link', 'multiuso');?>
			</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('flickr_link'));?>">
				<?php echo esc_html__('Flickr Link', 'multiuso');?>
			</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('rss_link'));?>">
				<?php echo esc_html__('Rss Link', 'multiuso');?>
			</label>
...
<?php
    ...
    public function widget( $args, $instance){
       ...
       if( $instance['google_scholar_link'] ){
          echo '<a href="'.esc_url($instance['google_scholar_link']).'" target="_blank" title="Google Scholar"><i class="fa fa-google"></i></a>';
       }
       ...
       if( $instance['flickr_link'] ){
          echo '<a href="'.esc_url($instance['flickr_link']).'" target="_blank" title="Flickr"><i class="fa fa-foursquare"></i></a>';
       }
...
function multiuso_register_social_widget(){
    register_widget('MULTIUSO_Social_Widget');
}
add_action('widgets_init', 'multiuso_register_social_widget');